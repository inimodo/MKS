...
#define M_STATUS_BUFFER	{{ M_WIDTH/2,0},	 { M_WIDTH/2 ,M_TOP },16}
#define M_REQUEST_BUFFER {{ 0,0},		 {M_WIDTH/2,M_TOP},16}

#define M_FEEDBACK_BUFFER	{{0,M_TOP},		 { M_WIDTH/2,M_HEIGHT }, 0}
#define M_MSTFILE_BUFFER	{{M_WIDTH/2,M_TOP},{ M_WIDTH/2 ,M_HEIGHT },0}
...
#define M_FILE_PAFILEEX (CLPSTR)".mpt"

#define M_FUNC_ARGS 4
#define M_FUNC_COUNT 14
#define M_FUNC_KWLEN 8
#define M_FUNC_KWLENRAW (M_FUNC_KWLEN-1)
#define M_MSGSIZE 32
#define M_FILEBUFFERSIZE 100


#define M_BUFFERS 4
#define M_BUFFER_FEEDBACK 0
#define M_BUFFER_MSTFILE 1
#define M_BUFFER_REQUEST 2
#define M_BUFFER_STATUS 3

#define M_MESSAGES 11
...
#define M_MESSAGES_FILE_UNKNOWN 10
#define M_MESSAGES_FILE_READF 11
#define M_MESSAGES_FILE_WRITEF 12
#define M_MESSAGES_FILE_OKAY 13
#define M_MESSAGES_FILE_FACCESS 14
...
#define M_COLOR_FUNCTION		 M_COLOR(14)
