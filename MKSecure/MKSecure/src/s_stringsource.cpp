...
char C_MKSS_K_CLEAR[_MKSS_REGFUNCTIONSIZE] = "clear";
char C_MKSS_K_CLEAR_FAILED[_MKSS_MSGSIZE] = "BUFFER NOT FOUND";
char C_MKSS_K_CLEAR_GOOD[_MKSS_MSGSIZE] = "BUFFER CLEARED";

char C_MKSS_K_INPUT[_MKSS_REGFUNCTIONSIZE] = "input";
char C_MKSS_K_INPUT_FAILED[_MKSS_MSGSIZE] = "BUFFER NOT FOUND";
char C_MKSS_K_INPUT_GOOD[_MKSS_MSGSIZE] = "BUFFER SET";
